...
pbxProject.prototype.addTargetDependency = function(target, dependencyTargets) {
    ...
    let pbxTargetDependencySection = this.hash.project.objects[PBXTargetDependency] = this.hash.project.objects[PBXTargetDependency] || {};
    let pbxContainerItemProxySection = this.hash.project.objects[PBXContainerItemProxy] = this.hash.project.objects[PBXContainerItemProxy] || {};
...
pbxProject.prototype.addContainerItemProxy = function(remoteContainer, remoteGlobalIDString, name) {
    let pbxContainerItemProxy = 'PBXContainerItemProxy';
    this.hash.project.objects[pbxContainerItemProxy] = this.hash.project.objects[pbxContainerItemProxy] || {};
    let pbxTargetDependencySection = this.hash.project.objects[pbxContainerItemProxy] 
